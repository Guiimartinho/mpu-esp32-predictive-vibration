...
const char* ssid_wifi = "Virus_13_2g";  //"Felipe";
const char* password_wifi = "259731gui";
const char* broker_mqtt = "ec2-3-90-96-154.compute-1.amazonaws.com"; //endereço do broker MQTT
